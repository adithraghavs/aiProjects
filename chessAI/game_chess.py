...
class Game():
    ...
    def __init__(self):
        ...
        self.font2 = pygame.font.SysFont("calibri", 72)
    ...
    def Menu(self):
        ...
        txt = self.font2.render("PyChess", True, RED)
        txt_center = (
            SCREEN_SIZE/2 - txt.get_width() // 2,
            SCREEN_SIZE/2 - txt.get_height() // 2
        )

        txt2 = self.font.render("", True, GREEN)
        txt2_center = (
            SCREEN_SIZE/2 - txt2.get_width() // 2,
            SCREEN_SIZE/2 + 30
        )
        # txt2rect = txt2.get_rect()
        txt3 = self.font.render("Human vs. AI", True, BLACK)
        txt3_center = (
